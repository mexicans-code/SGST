...
class MercadoPagoBoundary extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidCatch(error) {
        console.error('Mercado Pago no disponible en modo demo:', error);
    }
    render() {
        if (this.state.error) {
            return (
                <div className="alert alert-info mb-0">
                    Mercado Pago no está disponible en el modo demostración.
                    Usa la opción <strong>Tarjeta de crédito o débito (Manual)</strong> para completar tu reserva.
                </div>
            );
        }
